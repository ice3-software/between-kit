//
//  I32CollectionViewsAllPropertiesController.h
//  BetweenKit
//
...
@interface I32CollectionViewsAllPropertiesController : UIViewController<UICollectionViewDataSource, UICollectionViewDelegate, I3DragDataSource>
