...
@interface I3HighlightedViewModel : NSObject
...
@implementation I3HighlightedViewModel
...
@interface I3FunkRenderDelegate ()
...
@implementation I3FunkRenderDelegate
...
-(id) initWithPotentialDstViews:(NSArray *)views andDeleteArea:(UIView *)deleteArea{
    ...
    if(self){
        ...
        [views enumerateObjectsUsingBlock:^(id obj, NSUInteger idx, BOOL *stop){
            I3HighlightedViewModel *viewModel = [[I3HighlightedViewModel alloc] init];
...
-(void) invalidatedHightlighteDstAt:(CGPoint) globalPoint inCoordinator:(I3GestureCoordinator *)coordinator{
    ...
    for(I3HighlightedViewModel *viewModel in self.potentialDestinations){
