...
#import "CustomRenderViewController.h"
...
@interface CustomRenderViewController ()
...
@implementation CustomRenderViewController
...
-(void) viewDidLoad{
    ...
    self.dragCoordinator.renderDelegate = [[FunkRenderDelegate alloc] initWithPotentialDstViews:@[self.leftTable, self.rightCollection, self.deleteArea] andDeleteArea:self.deleteArea];
